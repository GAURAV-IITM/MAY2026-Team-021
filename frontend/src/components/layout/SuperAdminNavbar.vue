<template>
  <header class="app-navbar super-admin-navbar">
    <div class="app-navbar__brand">
      <button
        ...
        aria-label="Toggle super admin sidebar"
    ...
    <div class="app-navbar__actions" aria-label="Super Admin toolbar">
      ...
      <span class="app-navbar__library">{{ platformName }}</span>
...
const currentUserName = computed(() => currentUser.value?.name || 'Super Admin User')
const roleLabel = computed(() => currentUser.value?.roleLabel || currentRole.value || 'Super Admin')
const platformName = 'Smart Library Platform'
...
<!--
TODO: Add platform-level navigation after Super Admin workflows are finalized.
-->
